...
INSERT INTO `main`.`category` (`id`, `parent_id`, `name`, `type`) VALUES (1002, 0, '외국어', 2);
INSERT INTO `main`.`category` (`id`, `parent_id`, `name`, `type`) VALUES (1002, 0, '음악', 2);
INSERT INTO `main`.`category` (`id`, `parent_id`, `name`, `type`) VALUES (1002, 0, 'Art', 2);
INSERT INTO `main`.`category` (`id`, `parent_id`, `name`, `type`) VALUES (1002, 0, '액티비티', 2);
